...
cartArticleElement.setAttribute("data-id", localStorage.getItem("id"));
...
cartImgElement.src = localStorage.getItem("img");
cartImgElement.alt = localStorage.getItem("alt");
...
cartNameElement.innerHTML = localStorage.getItem("name");
cartTitlePriceDiv.appendChild(cartNameElement);
// Create price tag.
const cartPriceElement = document.createElement("p");
cartPriceElement.innerHTML = `${localStorage.getItem("price")} €`;
